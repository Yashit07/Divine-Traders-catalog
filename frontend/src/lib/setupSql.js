// The one-shot Supabase setup script, shipped inside the app so the admin
// can copy-paste it in one click without hunting for a file.
export const SETUP_SQL = `-- =============================================
-- Divine Traders — Supabase Setup (paste & run)
-- =============================================
...
-- 4. RLS (permissive — internal catalog, single shared admin password)
...
// Project ref parsed from VITE_SUPABASE_URL, used to build a direct SQL-editor link
